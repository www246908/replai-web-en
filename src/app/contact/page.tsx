  ...
  return (
    <div className="flex flex-col gap-2">
      <label className="font-pg-display text-xs font-bold uppercase tracking-wider text-pg-fg">
        {label}
        {required && (
          <span className="ml-1 text-pg-secondary">*</span>
        )}
      </label>
...
const inputClass = `
  ...
  focus:outline-none focus:border-pg-accent
  focus:shadow-[4px_4px_0_0_var(--pg-accent)]
...
function SuccessCard() {
  return (
    ...
    >
      ...
      <h2 className="font-pg-display text-2xl font-extrabold text-pg-fg">
        Message received!
      </h2>

      <p className="mx-auto mb-8 mt-3 max-w-xs font-pg-body leading-relaxed text-pg-muted-fg">
...
export default function ContactPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-pg-bg pt-16">
      <div
        aria-hidden
        className="pg-dots pointer-events-none absolute inset-0 opacity-60"
      />
      ...
      <div className="relative mx-auto max-w-xl px-5 py-16 sm:px-8 lg:py-24">
        ...
        >
          ...
          <p className="mt-6 font-pg-body leading-relaxed text-pg-muted-fg">
            Submit your form and we’ll reach out within 1 business
            day.
            <br />
            No pressure — just a casual consultation to explore your
            options.
          </p>
        </motion.div>
            ...
            >
              ...
              {state === "error" && (
                <p className="rounded-lg border-2 border-pg-secondary bg-pg-secondary/10 px-4 py-3 font-pg-body text-sm text-pg-fg">
                  ...
                  <a
                    href="mailto:replaii.official@gmail.com"
                    className="font-bold underline"
                  >
                    replaii.official@gmail.com
                  </a>
                </p>
              )}
              ...
              <p className="mt-1 text-center font-pg-body text-xs text-pg-muted-fg">
                By submitting, you agree to be contacted by Replai.
                We will never send spam messages.
              </p>
            </form>
          )}
        </motion.div>
